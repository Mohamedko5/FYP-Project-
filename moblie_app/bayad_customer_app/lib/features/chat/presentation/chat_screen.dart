  ...
  Future<void> _shareCard() async {
    ...
    try {
      await ref
          ...
          .shareCustomerCard(clientMessageId: _clientMessageId());
      await _refresh();
    } catch (_) {
                ...
                child: rows.isEmpty
                    ? ListView(
                        ...
                        children: [
                          ...
                          Center(child: Text(l10n.startConversation)),
                        ],
                      )
                    : ListView.separated(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadiusDirectional.only(
            ...
            bottomStart: Radius.circular(isMine ? 20 : 6),
            bottomEnd: Radius.circular(isMine ? 6 : 20),
          ),
        ...
        child: Column(
          ...
          children: [
            if (message.messageType == 'customer_card' &&
                message.cardSnapshot != null)
    ...
    return Column(
      ...
      children: [
        ...
        Directionality(
          ...
          child: Text(snapshot.customerCode),
        ),
        Text('${l10n.customerType}: ${snapshot.customerType}'),
        Directionality(
          textDirection: TextDirection.ltr,
          child: Text(snapshot.phone),
        ),
        Directionality(
          textDirection: TextDirection.ltr,
...
class _AttachmentTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    final label = attachment.attachmentType == 'image'
        ? l10n.image
        : l10n.document;
    return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                IconButton(
                  onPressed: isSending ? null : onShareCard,
                  icon: const Icon(Icons.badge_outlined),
                  tooltip: l10n.shareCustomerCard,
                ),
                const Spacer(),
                FilledButton(
