              ...
              children: [
                const Card(
                  child: Padding(
                    ...
                    child: Text(
                      'Your Order will be reviewed by Bayad Company before an Invoice is created.',
                    ),
                  ),
                ),
                ...
                FilledButton(
                  ...
                  child: Text(_submitting ? 'Submitting...' : 'Place Order'),
                ),
              ],
            ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'Your Order has been submitted and is waiting for Admin review.',
